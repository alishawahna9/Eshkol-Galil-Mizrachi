...
function AuthoritiesPageContent() {
  ...
  const [filters, setFilters] = useState<{
    ...
    ageGroup?: string;
    gender?: string;
  }>({metric: "total_population", year: "2023"});
            ...
            <div className="w-full">
              <div className="max-w-275">
                ...
                <div>
                  <AuthorityTabs
                    tableComponent={
                      <AuthoritiesResults filters={filters} selectedAuthority={selectedAuthority} />
                    }
...
export default function AuthoritiesPage() {
  return (
    <Suspense
      fallback={<div className="flex items-center justify-center min-h-screen">טוען...</div>}>
